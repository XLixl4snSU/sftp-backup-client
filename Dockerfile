...
RUN wget https://github.com/OliveTin/OliveTin/releases/download/2025.11.25/OliveTin_linux_amd64.apk && apk add --allow-untrusted OliveTin_linux_amd64.apk && rm OliveTin_linux_amd64.apk
COPY ./olivetin/config.yaml /etc/OliveTin/
COPY ./scripts/* /home/scripts/
RUN chmod +x /home/scripts/*; ln /home/scripts/backup_now.sh /usr/bin/backup-now
ENV backup_version=3.5.2
